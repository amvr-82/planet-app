          ...
          {slides.map((item, i) => (
            <div key={i} className="w-full shrink-0 flex flex-col justify-end ">
              <div className="flex flex-col gap-2 my-9 p-2 mx-10">
                ...
                <button className="cursor-pointer text-white/75 text-[20px] border-2 border-white/50 rounded-xl w-40 h-12 hover:bg-white/20 active:bg-white/40 transition-colors duration-150">
                  Buy Now
                </button>
              </div>
            </div>
