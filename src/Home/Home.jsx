...
export default function Home() {
  return (
    <div>
      ...
      {/* دیو کرات 2بزرگ زیر هدینگ */}

      <div className="flex flex-row-reverse card1 rounded-[90px] w-[90%] h-80 ml-auto mr-auto mt-50 justify-around ">
        {/* دیو عکس */}
        <div className="z-50 -mt-40 -ml-20  pointer-events-none">
          <img src="./public\assets\image\plant3.png" alt="" width={400} />
        </div>
        {/* دیو متناا و دکمه */}
        <div className=" text-white/70 pr-10 flex gap-5 flex-col mt-8">
          <p className="text-[30px] font-bold">For Fresh Decs Ai Plat</p>
          <p className="text-[15px] font-medium">
            Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
            eiusmod <br /> tempor incididunt ut labore et dolore magna aliqua
          </p>
